...
$global:github_path   = "hpcc/local/hpcc-localfile-logging" # localfile + hpcc + logging
#$global:github_path   = "hpcc/local/localfile\,elastic/beats\,elastic/elasticsearch/local\,elastic/kibana"  # localfile + hpcc + logging

#$global:github_path   = "hpcc/local/localfile"  # releases/local
#$global:github_path   = "hpcc/local/default"  # releases/local
